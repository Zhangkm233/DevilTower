...
public class DialogManager : MonoBehaviour
{
    ...
    public void HandleWithName() {
        ...
        illuImage.sprite = dialogName.text switch {
            ...
            "操作交互   1" => illustrationSprites[11],
            "操作交互   2" => illustrationSprites[12],
            "操作交互   3" => illustrationSprites[13],
            "操作交互   4" => illustrationSprites[14],
            "操作交互   5" => illustrationSprites[15],
            "操作交互   6" => illustrationSprites[16],
            "操作交互   7" => illustrationSprites[17],
            "战斗教学   1" => illustrationSprites[18],
            "战斗教学   2" => illustrationSprites[19],
            "战斗教学   3" => illustrationSprites[20],
            "战斗教学   4" => illustrationSprites[21],
            "战斗教学   5" => illustrationSprites[22],
            "卡牌教学   1" => illustrationSprites[23],
